...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    postMessage("https://daddyleagues.com/CircJerkington2/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("https://daddyleagues.com/CircJerkington2/players?name="+rep+"&position=all&team=all");
